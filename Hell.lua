...
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/XanaXNaxZ/AchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAcho/refs/heads/main/Hellui.lua"))();        
local win = ui:new("HellScript")
--
...
local about = UITab1:section("玩家信息(缝的)",false)
